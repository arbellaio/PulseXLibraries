...
namespace PulseXLibraries.ViewModels.Base
{
     public class BaseViewModel : INotifyPropertyChanged
    {
        public ICommand GoBackCommand => new Command(GoBackCommandLocker.Execute);
        protected CommandLockerHelper GoBackCommandLocker => new CommandLockerHelper(async () => { await GoBack(); });
