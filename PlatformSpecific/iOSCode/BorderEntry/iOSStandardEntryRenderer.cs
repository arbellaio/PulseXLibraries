...
// using CoreGraphics;
// using Foundation;
// using PulseXLibraries.Controls.BorderEntry;
// using PulseXMultiPlatform.Controls.BorderEntry;
// using UIKit;
// using Xamarin.Forms;
// using Xamarin.Forms.Platform.iOS;
//
// [assembly: ExportRenderer(typeof(StandardEntry), typeof(iOSStandardEntryRenderer))]
// namespace PulseXMultiPlatform.Controls.BorderEntry
// {
...
//         {
//             var insets = new UIEdgeInsets((float)Padding.Top, (float)Padding.Left, (float)Padding.Bottom,
//                 (float)Padding.Right);
